...
const TASK_BANK_SEED = [
  ...
  /* ============================================================
     ЗАДАНИЕ №1 — ПЛАНИМЕТРИЯ. Прототипы ФИПИ (партия 1 из 3)
     ============================================================ */

  /* --- Произвольный треугольник --- */
  { examTaskNumber:1, topic:'Планиметрия', difficulty:'easy', isPrototype:true,
    statement:'В треугольнике ABC угол A равен 37°, стороны AC и BC равны. Найдите угол C. Ответ дайте в градусах.',
    answer:'106',
    solution:'AC = BC, значит треугольник равнобедренный с основанием AB. Тогда ∠A = ∠B = 37°. ∠C = 180° − 37° − 37° = 106°.' },

  { examTaskNumber:1, topic:'Планиметрия', difficulty:'easy', isPrototype:true,
    statement:'В треугольнике ABC AD — биссектриса, угол C равен 104°, угол CAD равен 5°. Найдите угол B. Ответ дайте в градусах.',
    answer:'66',
    solution:'AD — биссектриса, значит ∠BAC = 2·∠CAD = 10°. Тогда ∠B = 180° − 10° − 104° = 66°.' },

  { examTaskNumber:1, topic:'Планиметрия', difficulty:'easy', isPrototype:true,
    statement:'В треугольнике ABC AB = BC. Внешний угол при вершине B равен 94°. Найдите угол C. Ответ дайте в градусах.',
    answer:'47',
    solution:'Внутренний ∠B = 180° − 94° = 86°. AB = BC ⇒ ∠A = ∠C. ∠C = (180° − 86°)/2 = 47°.' },

  { examTaskNumber:1, topic:'Планиметрия', difficulty:'easy', isPrototype:true,
    statement:'В треугольнике ABC стороны AC и BC равны, угол C равен 72°, угол CBD — внешний. Найдите угол CBD. Ответ дайте в градусах.',
    answer:'126',
    solution:'AC = BC ⇒ ∠A = ∠B = (180° − 72°)/2 = 54°. ∠CBD = 180° − 54° = 126°.' },

  { examTaskNumber:1, topic:'Планиметрия', difficulty:'medium', isPrototype:true,
    statement:'В треугольнике ABC угол A равен 56°, углы B и C — острые, высоты BD и CE пересекаются в точке O. Найдите угол DOE. Ответ дайте в градусах.',
    answer:'124',
    solution:'В четырёхугольнике AEOD: ∠A = 56°, ∠AEO = 90°, ∠ADO = 90°. ∠EOD = 360° − 56° − 90° − 90° = 124°.' },

  { examTaskNumber:1, topic:'Планиметрия', difficulty:'medium', isPrototype:true,
    statement:'Угол при вершине, противолежащей основанию равнобедренного треугольника, равен 30°. Боковая сторона равна 11. Найдите площадь треугольника.',
    answer:'30,25',
    solution:'S = ½·a·a·sin α = ½·11·11·sin 30° = 121/4 = 30,25.' },

  { examTaskNumber:1, topic:'Планиметрия', difficulty:'medium', isPrototype:true,
    statement:'Две стороны треугольника равны 21 и 28. Высота, опущенная на большую из этих сторон, равна 15. Найдите высоту, опущенную на меньшую из этих сторон.',
    answer:'20',
    solution:'S = ½·28·15 = 210. Высота к стороне 21: h = 2·210/21 = 20.' },

  /* --- Равнобедренный треугольник --- */
  { examTaskNumber:1, topic:'Планиметрия', difficulty:'easy', isPrototype:true,
    statement:'В равнобедренном треугольнике ABC с основанием AC внешний угол при вершине C равен 123°. Найдите величину угла BAC. Ответ дайте в градусах.',
    answer:'57',
    solution:'Внешний при C = 123°, значит внутренний ∠C = 57°. Основание AC ⇒ ∠A = ∠C = 57°.' },

  { examTaskNumber:1, topic:'Планиметрия', difficulty:'easy', isPrototype:true,
    statement:'В равнобедренном треугольнике ABC с основанием AC угол B равен 42°. Найдите величину угла ACB. Ответ дайте в градусах.',
    answer:'69',
    solution:'∠A = ∠C = (180° − 42°)/2 = 69°.' },

  { examTaskNumber:1, topic:'Планиметрия', difficulty:'medium', isPrototype:true,
    statement:'Высота BH равнобедренного треугольника ABC (AB = BC) равна 4, а основание AC равно 6. Найдите боковую сторону AB.',
    answer:'5',
    solution:'BH — высота к основанию ⇒ AH = HC = 3. AB = √(BH² + AH²) = √(16 + 9) = 5.' },

  { examTaskNumber:1, topic:'Планиметрия', difficulty:'medium', isPrototype:true,
    statement:'В равнобедренном треугольнике боковая сторона равна 13, а основание равно 10. Найдите высоту, проведённую к основанию.',
    answer:'12',
    solution:'Высота делит основание пополам: h = √(13² − 5²) = √(169 − 25) = 12.' },

  /* --- Прямоугольный треугольник --- */
  { examTaskNumber:1, topic:'Планиметрия', difficulty:'easy', isPrototype:true,
    statement:'В треугольнике ABC угол C равен 90°, BC = 12, cos B = 3/5. Найдите AB.',
    answer:'20',
    solution:'cos B = BC/AB = 3/5 ⇒ AB = BC / (3/5) = 12 · 5/3 = 20.' },

  { examTaskNumber:1, topic:'Планиметрия', difficulty:'easy', isPrototype:true,
    statement:'В треугольнике ABC угол C равен 90°, BC = 6, AB = 10. Найдите sin B.',
    answer:'0,8',
    solution:'AC = √(AB² − BC²) = √(100 − 36) = 8. sin B = AC / AB = 8/10 = 0,8.' },

  { examTaskNumber:1, topic:'Планиметрия', difficulty:'easy', isPrototype:true,
    statement:'В треугольнике ABC угол C равен 90°, sin A = 0,8. Найдите sin B.',
    answer:'0,6',
    solution:'sin A = cos B ⇒ cos B = 0,8. sin B = √(1 − cos²B) = √(1 − 0,64) = 0,6.' },

  { examTaskNumber:1, topic:'Планиметрия', difficulty:'medium', isPrototype:true,
    statement:'В треугольнике ABC угол C равен 90°, AC = 6, tg A = √5/2. Найдите AB.',
    answer:'9',
    solution:'tg A = BC/AC ⇒ BC = 6·√5/2 = 3√5. AB = √(AC² + BC²) = √(36 + 45) = √81 = 9.' },

  { examTaskNumber:1, topic:'Планиметрия', difficulty:'medium', isPrototype:true,
    statement:'В треугольнике ABC CD — медиана, угол C равен 90°, угол B равен 35°. Найдите угол ACD. Ответ дайте в градусах.',
    answer:'55',
    solution:'CD — медиана из прямого угла ⇒ CD = AD = BD. ∠A = 180° − 90° − 35° = 55°. Треугольник ACD равнобедренный, ∠ACD = ∠A = 55°.' },

  /* --- Трапеция --- */
  { examTaskNumber:1, topic:'Планиметрия', difficulty:'medium', isPrototype:true,
    statement:'Высота трапеции равна 10, площадь равна 150. Найдите среднюю линию трапеции.',
    answer:'15',
    solution:'S = m·h, где m — средняя линия. m = S/h = 150/10 = 15.' },

  { examTaskNumber:1, topic:'Планиметрия', difficulty:'easy', isPrototype:true,
    statement:'Основания трапеции равны 4 и 10. Найдите больший из отрезков, на которые делит среднюю линию одна из её диагоналей.',
    answer:'5',
    solution:'Диагональ делит среднюю линию на отрезки, равные половинам оснований: 2 и 5. Больший = 5.' },

  /* --- Параллелограмм --- */
  { examTaskNumber:1, topic:'Планиметрия', difficulty:'easy', isPrototype:true,
    statement:'Один угол параллелограмма больше другого на 40°. Найдите меньший угол. Ответ дайте в градусах.',
    answer:'70',
    solution:'Пусть меньший угол x, тогда x + (x+40) = 180 ⇒ 2x = 140 ⇒ x = 70°.' },
...
function userToJSON(u) {
  ...
  return {
    ...
    telegram: u.telegram_chat_id
      ? { chatId: Number(u.telegram_chat_id), username: u.telegram_username }
      : null
  };
}
...
app.get('/api/profile/teacher', auth, async (req, res) => {
  try {
    ...
    const bankCount = (await pool.query(`SELECT COUNT(*)::int AS n FROM task_bank ${isAdmin ? '' : 'WHERE owner_id=$1 OR is_public=true'}`, args)).rows[0].n;
    ...
    res.json({ classesCount, studentsCount, testsCount, booksCount, bankCount,
